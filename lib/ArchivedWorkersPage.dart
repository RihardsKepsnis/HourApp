...
class _ArchivedWorkersPageState extends State<ArchivedWorkersPage> {
  ...
  void initState() {
    super.initState();
    // Assume only admin can navigate here.
    setState(() {
      isLoading = false;
    });
  }
  ...
  /// Restore a worker from the archive.
  ...
  /// Permanently delete a worker and all his data.
  ...
  /// Builds the notification icon with a badge using a StreamBuilder.
...
/// NotificationsPopup widget displays unread notifications in a pop-up dialog.
