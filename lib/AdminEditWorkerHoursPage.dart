// lib/AdminEditWorkerHoursPage.dart

import 'package:flutter/material.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:intl/intl.dart';

/// AdminEditWorkerHoursPage allows an admin to pick an organization/city
/// entry for a given worker and date, edit its task hours, and save back.
...
class _AdminEditWorkerHoursPageState extends State<AdminEditWorkerHoursPage> {
  ...
  /// Each entry: {'organization':…, 'city':…, 'tasks': List<Map> }
  List<Map<String, dynamic>> _entries = [];

  /// Controllers for each entry/task, keyed by "<org>|<city>|<taskName>"
  final Map<String, TextEditingController> _controllers = {};

  /// Which entry is currently being edited?
  ...
  /// Save all entries back to Firestore
...
/// Custom clipper for a curved AppBar bottom.
