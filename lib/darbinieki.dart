...
class _DarbiniekiPageState extends State<DarbiniekiPage> {
  ...
  // Pievieno jaunu darbinieku ar visu dokumentu
  ...
  Future<void> _archiveEmployee(String docId) async {
    bool? confirmed = await showDialog<bool>(
      ...
      builder: (context) {
        return AlertDialog(
          title: const Text('Arhivēt darbinieku'),
  ...
  // Pārslēdz darbinieka konta statusu (atspējots/nav atspējots)
