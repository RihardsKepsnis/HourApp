...
import 'darbinieki.dart'; // Import the new admin-only page
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  // Load the user's name and role from Firestore.
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          SizedBox(height: screenWidth * 0.1), // Space for status bar.
          ...
          const Divider(color: Colors.black),
          // Admin-only: Darbinieki (Employees) page.
          if (_role == 'admin')
            ListTile(
